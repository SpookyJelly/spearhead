...
하늘을 가르는 천둥과 함께 강림하는 스톰캐스트 이터널즈는 죽음 그 자체도 두려워하지 않는다. 하지만 거듭되는 부활 속에서 그들은 인간이었던 자신의 기억과 감정을 조금씩 잃어간다 — 이것이 지그마가 그들에게 지운 진정한 대가다.`,
    ...
    spearheads: [
      {
        ...
        stats: { 공격력: 7, 생존력: 7, 기동성: 5, 미션수행: 4, 유틸리티: 4 },
        recommended: [
          "초반부터 강력한 병력으로 적을 찍어 누르고 싶으신 분",
          "강력한 개별 유닛을 컨트롤 하는 것을 즐기시는 분",
        ...
        playstyle:
          "강력한 영웅을 필두로 초반부터 적을 몰아치는 아미. 일제히 돌격해 적을 분쇄하는 공격적인 전략을 사용한다.",
...

      {
        ...
        recommended: [
          ...
          "전선을 유지하며 버티다 후반에 역전하는 짜릿함을 좋아하시는 분",
          "화려한 인드라스타 센터피스 미니어처를 페인팅하고 싶은 분",
        ],
        notRecommended: [
          "강력한 유닛들에만 의존하는 것을 싫어하시는 분",
  ...
  },
  {
    ...
    lore: `피와 살육의 신 케인을 숭배하는 전투 종교 집단. 도터즈 오브 케인은 스스로를 질서의 수호자라 여기지만, 그들이 바치는 신앙은 끝없는 피와 희생 위에 세워져 있다. 전장은 곧 제단이며, 적의 목숨은 의식을 완성하기 위한 공물이다.

이 집단의 중심에는 반신 "모라시-케인"이 있다. 그림자 여왕으로도 알려진 그녀는 케인의 이름 아래 신도들을 이끌지만, 동시에 그 신앙을 자신을 위한 권능으로 바꾸어왔다. 신성한 의식과 광기 어린 학살은 구분되지 않고 뒤섞이며, 신도들은 그것이 진정한 헌신이라 믿는다.

도터즈 오브 케인은 오더에 속해 있지만, 그 방식은 다른 어떤 세력보다도 잔혹하다. 그들에게 중요한 것은 정의나 자비가 아니라, 피가 충분히 흘렀는가이다 — 그리고 그 피가 향하는 대상이 누구인지는, 점점 더 불분명해지고 있다.`,
    ...
    spearheads: [
      {
        ...
        description: `케인의 성스러운 피 가마솥을 중심으로 결집한 수호 전단. 헤카티 크로넨이 선혈의 의식을 집전하는 동안, 학살의 자매들이 사방을 질주하며 적을 쓰러뜨린다. 전투가 고조될수록 케인의 가호가 더욱 강렬해진다.`,
        ...
        units: [
          ...
          },
          {
            ...
            role: "기간 보병",
            count: 5,
            description: "채찍과 방패를 들고 광란의 춤을 추며 싸우는 여전사들",
          },
          {
            name: "Sisters of Slaughter",
            role: "기간 보병",
          ...
          },
          {
            ...
            count: 9,
            description:
              "쇠뇌와 장검으로 무장한 채, 그림자 마법으로 전장을 누비는 전사들",
          },
        ],
        playstyle:
...
모든 클랜들은 끊임없이 서로 배신하고 다투지만, 외부의 적이 나타나면 쥐의 물결처럼 밀려들어 모든 것을 갉아먹는다. 기괴한 워프스톤 기술과 렛 오거 등의 돌연변이 괴물이 그들의 무기다.`,
    color: "#2a4a1a",
    accentColor: "#7fc41a",
    ...
    spearheads: [
      {
        ...
        units: [
          {
            ...
            count: 1,
            description:
              "전선을 직접 돌파하는 전사형 지휘관. 부상을 당하면 더욱 강해지는 광전사.",
          },
          {
            name: "Grey Seer",
            role: "지원 전력",
          ...
          },
          {
            ...
            count: 10,
            description:
              "끊임없이 충원되는 스케이븐의 중추. 점령지를 사수하고 고기방패 역할을 수행한다.",
          },
          {
            name: "Clanrats",
            role: "기간 보병",
        ...
        playstyle: `나우페스트 클로팩은 '전략적 소모전'이 핵심이다. 기간 보병인 클랜랫을 미끼로 던져 적을 묶어두고, 'Gnawhole Ambush' 규칙으로 보드 가장자리에서 괴수 전력인 랫 오거를 기습 투입해 적의 약점을 찌른다. 지원 전력의 마법과 지휘관의 부활 능력을 활용해 상대가 지칠 때까지 버티는 것이 승리 공식이다.`,
      ...
      },
      {
        ...
        description: `스크라이어 클랜의 미친 과학이 만들어낸 치명적인 화기 군단. 강력한 워프 라이트닝 캐논의 한 방과 중장갑 스톰파인드의 사격으로 적이 다가오기도 전에 잿더미로 만든다. 아군이 피해를 입더라도 적을 더 빨리 파괴하는 고화력 특화 아미.`,
        ...
        units: [
          {
            ...
            count: 1,
            description:
              "아미를 지휘하며 워프 마법을 사용한다. 스톰핀드와 시너지가 좋은 유틸리티 리더.",
          },
          {
            name: "Stormfiends",
            role: "정예 전력",
  ...
  },
  {
    ...
    lore: `죽음으로도 끝나지 않는 형벌을 받은 영혼들의 군세. 나이트헌트는 나가쉬의 의지에 의해 묶인 채, 끝없는 공포를 퍼뜨리도록 강요받는다.

이들은 생전의 죄나 집착에 따라 뒤틀린 모습으로 변형되어, 같은 고통을 영원히 반복한다. 한때 비겁했던 자는 끝없이 도망치고, 탐욕스러웠던 자는 사슬에 묶여 배회한다. 죽음은 해방이 아니다 — 오히려 진정한 형벌의 시작이다.

나이트헌트가 전장을 스쳐 지나가면, 육신은 물론 의지마저 무너진다. 그들은 단순히 적을 죽이는 것이 아니라, 공포 그 자체를 남긴다 — 그리고 그 공포는 또 다른 영혼을 이 저주받은 군세로 끌어들인다.`,
    color: "#1a3a5a",
    accentColor: "#4adfcf",
  ...
  },
  {
    ...
    lore: `죽음을 넘어선 권력을 쥔 흡혈귀 귀족들의 군세. 소울블라이트 그레이브로드는 저주받은 피를 통해 불사의 존재가 되었으며, 살아있는 자들을 지배하고 착취하는 것을 당연한 권리로 여긴다.

이들은 엄격한 위계 속에서 각자의 영토를 다스리며, 끝없는 언데드 군단을 이끌고 전쟁을 벌인다. 해골과 시체는 단순한 병력에 불과하고, 살아있는 자들은 피와 노동을 제공하는 자원일 뿐이다.

그들에게 전쟁은 생존이자 권력 투쟁이다. 갈증은 결코 사라지지 않으며, 그 굶주림은 더 많은 정복과 지배로 이어진다 — 그들의 왕국은 죽음 위에 세워졌지만, 그 욕망만큼은 여전히 살아 숨 쉬고 있다.`,
    color: "#3a1a5a",
    accentColor: "#c84a8f",
...
메가보스 고드락과 같은 위대한 전쟁군주 아래 뭉친 아이언죠즈는 영역을 가리지 않고 쳐들어가 가장 강한 적을 찾아 싸운다. 그들은 이기기 위해 싸우는 것이 아니라, 싸움 자체를 즐기기 위해 싸운다.`,
  ...
  },
  {
    ...
    lore: `늪지와 어둠 속에서 움직이는 교활한 오룩들. 크룰보이즈는 정면 승부를 피하고, 독과 함정, 기습을 통해 적을 무너뜨리는 전투 방식을 선호한다.

이들은 인내심 있게 상대를 지켜보다가 가장 약한 순간을 노려 공격한다. 독이 묻은 무기와 괴물들을 앞세워 적을 서서히 약화시키고, 공포와 혼란 속에서 전장을 장악한다.

크룰보이즈에게 전쟁은 힘겨루기가 아니다. 승리란 상대를 속이고, 무너뜨리고, 도망칠 기회조차 주지 않는 것이다 — 그리고 그 모든 과정은 그들에게 자랑스러운 전술이다.`,
    color: "#1a5a1a",
    accentColor: "#c8a84c",
...
지그마의 명 아래 세워진 이 도시들은 각기 다른 신념과 이해관계를 지녔지만, 살아남기 위해 하나로 뭉쳤다. 끝없는 전쟁 속에서 그들은 매일을 버텨낸다 — 신의 번개도, 불사의 육체도 없이, 오직 의지와 강철, 그리고 서로에 대한 믿음으로.`,
    ...
    spearheads: [
      {
        ...
        stats: { 공격력: 5, 생존력: 5, 기동성: 7, 미션수행: 6, 유틸리티: 6 },
        recommended: [
        ...
        notRecommended: [
          ...
          "신비로운 마법과 기도로 전장의 판도를 뒤집고 싶으신 분",
        ],
        units: [
          {
  ...
  },
  {
    ...
    lore: `불의 신 그림니르의 후예를 자처하는 듀아딘 광전사들. 그들은 신의 힘이 깃들었다고 믿는 ‘우르-골드’를 수집하기 위해, 계약과 보수를 대가로 모든 전장에 뛰어든다.
파이어슬레이어들은 전투를 단순한 생계나 명예가 아닌 신앙으로 여긴다. 그들의 육신에 새겨지는 황금 룬은 그림니르의 힘을 일시적으로 불러오며, 언젠가 모든 우르-골드를 되찾아 죽은 신을 다시 완전하게 만들기를 꿈꾼다.`,
    color: "#8a3a10",
    accentColor: "#f0a030",
    ...
    spearheads: [
      {
        ...
        stats: { 공격력: 10, 생존력: 3, 기동성: 3, 미션수행: 6, 유틸리티: 7 },
        recommended: [
          "매우 높은 공격력으로 바탕으로 정면 승부를 즐기는 분",
    ...
    spearheads: [
      {
        ...
        units: [
          ...
          },
          {
            ...
            count: 10,
            description:
              "거대한 활을 다루는 보병대. 후퇴/질주 이후에도 치명적인 화살을 퍼붓는다.",
          },
        ],
        ...
        units: [
          {
            ...
            count: 1,
            description:
              "비행슈트를 입은 지휘관, 비행 중인 아군을 치유하는 능력을 보유하고 있다",
          },
          {
          ...
          },
          {
            ...
            count: 3,
            description:
              "하늘을 날며 지상의 적을 저격하고 필요 시 신속하게 거점을 점령하는 공중 유격대. 적군의 이동 타이밍에도 움직일수 있는 독특한 능력을 보유하고 있다.",
          },
        ],
    ...
    spearheads: [
      {
        ...
        stats: { 공격력: 7, 생존력: 6, 기동성: 5, 미션수행: 7, 유틸리티: 9 },
        recommended: [
...
그들은 ‘위대한 계획’이라 불리는 이해할 수 없는 목적을 수행하기 위해 움직이며, 혼돈의 세력을 철저히 말살하는 데 모든 것을 바친다. 감정이나 자비는 없다 — 세라폰에게 전쟁은 선택이 아니라, 이미 정해진 질서를 완성하기 위한 과정일 뿐이다.`,
    ...
    spearheads: [
      ...
      },
      {
        ...
        stats: { 공격력: 6, 생존력: 5, 기동성: 8, 미션수행: 8, 유틸리티: 7 },
        recommended: [
        ...
        units: [
          ...
          },
          {
            ...
            count: 3,
            description:
              "하늘을 누비는 민첩한 괴수들. 재빠른 이동으로 아미의 미션 달성을 돕는다.",
          },
          {
    ...
    spearheads: [
      {
        ...
        units: [
          ...
          },
          {
            ...
            count: 3,
            description:
              "숲의 수호자들. 거대한 활로 적의 정예병들을 쏘아죽이는 아미의 실질적인 타격대.",
          },
          {
            name: "Treelord",
            role: "괴수",
    ...
    spearheads: [
      {
        ...
        playstyle: `플럭스블레이드 커번은 '거점 유지와 사격'이 핵심입니다. 마기스터의 마법과 데스티니 다이스를 활용해 중요한 순간에 확실한 성공을 보장받아야 합니다. 
        아콜라이트와 잔고어가 전선을 끈덕지게 유지하는 동안
        플레이머가 적을 녹여버리고, 스크리머가 후방을 교란하는 영리한 플레이가 요구됩니다.`,
...
마곳킨 오브 너글은 고통과 절망 속에서도 기묘한 평온을 유지한다. 모든 것은 결국 썩어 돌아가고, 그 속에서 새로운 생명이 태어난다고 믿기 때문이다. 그들에게 전쟁은 파괴가 아니라 순환의 일부다 — 세상은 반드시 무너지고, 다시 피어나야 한다.`,
    ...
    spearheads: [
      ...
      },
      {
        ...
        playstyle: `부보닉 셀은 '거머리 같은 점령'이 핵심입니다. 롯브링어의 지휘 아래 너글링들이 끈질기게 재생하며 거점을 지킵니다. 비스트 오브 너글은 적의 돌격을 방해하며 전선을 흐트러뜨리고, 롯마이어들은 후열에서 치명적인 맹독침을 쏘아 적을 소모시킵니다.`,
    ...
    spearheads: [
      {
        ...
        playstyle: `캐리언 리테이너는 '증서 관리'가 승패를 결정합니다. 영웅들이 안전하고 확실하게 증서를 모으는 동안 몰벡 나이트가 적의 시선을 끌어야 합니다. 적절한 타이밍에 쌓인 포인트를 소모해 전멸한 유닛을 다시 불러내거나 공격 속도를 높여 한 번에 전황을 뒤집는 정교한 운영이 필요합니다.`,
      ...
      },
      {
        ...
        stats: { 공격력: 4, 생존력: 4, 기동성: 6, 미션수행: 10, 유틸리티: 7 },
        recommended: [
        ...
        playstyle: `샤넬 워치는 '미션러닝'에 특화되어 있습니다. 기간 보병인 비스트 플레이어는 공격력은 약하지만 텔레포트가 가능하여 승점을 벌어오기 쉽고, 크립트 플라이어도 긴 이동거리와 비행 능력을 사용해
        임무를 수월히 달성할 수 있습니다. 부족한 전투력은 고유 기믹인 망상을 유지하며 향상시키는 것이 중요합니다.
        `,
