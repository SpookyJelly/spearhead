    ...
    <div className={styles.page} data-alliance={faction.alliance}>
          ...
          >
            <span className={styles.gwLinkIcon} aria-hidden="true">
              <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 1.5A6.5 6.5 0 1 0 14.5 8 6.507 6.507 0 0 0 8 1.5zm0 11.8A5.3 5.3 0 1 1 13.3 8 5.306 5.306 0 0 1 8 13.3z" fill="currentColor"/>
                <path d="M8 5.5a.6.6 0 1 0 0-1.2.6.6 0 0 0 0 1.2zM8.6 6.8H7.4v4.4h1.2V6.8z" fill="currentColor"/>
              </svg>
            </span>
            공식 사이트에서 모델 구경하기
            <span className={styles.gwLinkArrow} aria-hidden="true">↗</span>
          </a>
        </div>
      ...
      <div className={styles.body}>
          ...
          <div className={styles.recGrid}>
            <div className={styles.recBox}>
              <div className={styles.recHeader}>
                <span className={styles.recIconYes} aria-hidden="true">✦</span>
            ...
            <div className={styles.recBox}>
              <div className={styles.recHeader}>
                <span className={styles.recIconNo} aria-hidden="true">✦</span>
        ...
        <section className={styles.section}>
          ...
          >
            <div className={styles.playstyleIcon} aria-hidden="true">⚔</div>
...
const ROLE_STYLES = {
  '지휘관':  { bg: 'rgba(201,168,76,0.12)',  border: 'rgba(201,168,76,0.4)',  text: '#c9a84c' },
  '핵심 전력': { bg: 'rgba(100,160,220,0.08)', border: 'rgba(100,160,220,0.3)', text: '#64a0dc' },
  '정예 전력': { bg: 'rgba(180,100,220,0.08)', border: 'rgba(180,100,220,0.3)', text: '#b464dc' },
  '기동 전력': { bg: 'rgba(100,220,160,0.08)', border: 'rgba(100,220,160,0.3)', text: '#64dc9a' },
  '기병 전력': { bg: 'rgba(100,220,160,0.08)', border: 'rgba(100,220,160,0.3)', text: '#64dc9a' },
  '원거리 전력':{ bg: 'rgba(220,160,100,0.08)', border: 'rgba(220,160,100,0.3)', text: '#dc9a64' },
  '돌격 전력': { bg: 'rgba(220,100,100,0.08)', border: 'rgba(220,100,100,0.3)', text: '#dc6464' },
  '지원 전력': { bg: 'rgba(100,200,220,0.08)', border: 'rgba(100,200,220,0.3)', text: '#64c8dc' },
  '중장 전력': { bg: 'rgba(160,140,120,0.08)', border: 'rgba(160,140,120,0.3)', text: '#a08c78' },
  '척후 전력': { bg: 'rgba(180,220,100,0.08)', border: 'rgba(180,220,100,0.3)', text: '#b4dc64' },
  '정예 기병': { bg: 'rgba(220,100,140,0.08)', border: 'rgba(220,100,140,0.3)', text: '#dc648c' },
}

function UnitCard({ unit, faction }) {
  const rs = ROLE_STYLES[unit.role] || ROLE_STYLES['핵심 전력']
  return (
    <div
    ...
    >
      <div className={styles.unitTop}>
        <span className={styles.unitCount} style={{ color: rs.text }}>×{unit.count}</span>
        <span
