  ...
  useEffect(() => {
    ...
    const delay = setTimeout(() => {
      function animate(ts) {
        ...
        setDisplay(
          Object.fromEntries(STAT_KEYS.map(k => [k, (targetRef.current[k] || 0) * e]))
        )
        ...
        >
          ...
          {Array.from({ length: LEVELS }, (_, i) => i + 1).map(lvl => (
            <polygon
              ...
              fill="none"
              stroke={lvl === LEVELS ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.05)'}
          ...
          <div key={key} className={styles.row}>
            ...
            <div className={styles.track}>
              <div
                ...
                style={{ width: `${(sliderStats[key] / MAX_VAL) * 100}%`, background: color }}
              />
              <input
                type="range"
                min={0}
