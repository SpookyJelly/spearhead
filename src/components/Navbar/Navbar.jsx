...
const FEEDBACK_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLSfS_8W2S1LkFU3X8JcCyXxOuKgtcdCdabCQYECAkwJR7bWWyQ/viewform?usp=publish-editor";
    ...
    <nav className={styles.navbar}>
      <div className={styles.inner}>
        ...
        >
          ...
          >
            <path
              d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 12.5A5.5 5.5 0 1 1 8 2.5a5.5 5.5 0 0 1 0 11zm.75-3.25H7.25v1.5h1.5v-1.5zm0-6H7.25v4.5h1.5v-4.5z"
              fill="currentColor"
            />
          </svg>
          버그 제보
